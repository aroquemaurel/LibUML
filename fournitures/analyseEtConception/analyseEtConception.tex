...
\newpage
	...
	\begin{tikzpicture}
		...
		\node at (1.5,0.2) {\textbf{eltGraphique}} ;
		\node at (2.0,-0.3) {\textit{ElementGraphique}} ;
		\node at (2.0,-0.7) {\textbf{eltModelisation}} ;
		...
		\node at (1.0,-10.8) {\textbf{diagramme}} ;
	...
	\end{wrapfigure}
		...
		en quatre \glo{paquetages}{Paquetage}{Un paquetage en Java est un regroupement de classes ayant la même thématique.} comme suit :\\
