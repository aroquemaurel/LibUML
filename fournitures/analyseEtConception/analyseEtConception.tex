...
%\setcounter{tocdepth}{4}
	...
	$\rhd$ \url{http://documentation.joohoo.fr/libUML/public} (Documentation des méthodes publiques)\\
	$\rhd$ \url{http://documentation.joohoo.fr/libUML/private} (Documentation des méthodes privée, pu\-bliques et des attributs)\\
