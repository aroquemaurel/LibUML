...
\date[ ~ ~ ~ 01 / 12 / 2011] % (facultatif, peut être une abréviation du nom de la conférence)
{\today}
...
\end{frame}
\input{intro.tex}
\section{Besoin et contraintes}
\subsection{Besoins}
\begin{frame}{Les besoins}
\begin{itemize}
	\item<1-> Dessiner un diagramme de cas d'utilisation 
	\item<2-> Dessiner un diagramme de séquence 
	\item<3-> Dessiner un diagramme de classe
	\item<4-> Avoir un démonstrateur 
\end{itemize}
	\begin{figure}
		\begin{center}
	...
	\includegraphics<3,4>[width=1.3cm]{diagrammeClasse.jpeg} 
		\end{center}
		\caption{Les différents diagrammes}
	\end{figure}
\end{frame}
\subsection{Contraintes}
\begin{frame}{Les contraintes}
	\begin{itemize}
		\item Rapidité et légèreté
			\pause
		\item Portabilité 
			\pause
		\item Ergonomie
...
\end{frame}
\subsection{Planning}
\begin{frame}{\bsc{Gantt} prévisionnel}
		\includegraphics[width=10cm]{projetiut-gantt.png}	
\end{frame}
\appendix
\begin{frame}{Conclusion}
	...
	\begin{block}{Mais \ldots}
		...
		Mauvaise évaluation du travail à réaliser \newline
	\end{block}
\end{frame}
\end{document}
