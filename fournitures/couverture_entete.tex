...
\DeclareTextFontCommand{\policeGlossaire}{\fontfamily{ptm}\selectfont}
\DeclareTextFontCommand{\policeCode}{\fontfamily{cmtt}\selectfont}

\newwrite\glossaireVar
\openout\glossaireVar=glossaire
\write\glossaireVar{\noexpand\chapter{Glossaire}}
\newcommand{\glo}[3]{
\policeGlossaire{\hspace{-4px}#1\hspace{-8px}}
