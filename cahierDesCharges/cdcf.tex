...
\begin{document}
	...
	\subsection{Présentation du projet}
		...
		\subsubsection{La norme UML} 
			...
			Ce langage est adaptée pour de la conception orientée objet, il est divisé en plusieurs diagrammes, en voici quelques exemples (la liste n'est pas exhaustive): 
			\begin{itemize}
