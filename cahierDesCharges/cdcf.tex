...
\begin{document}
	...
	\subsection{Présentation du projet}
		...
		\subsubsection{La norme UML} 
			...
			Ce langage est utilisé dans le cadre de la conception orientée objet, il est divisé en plusieurs diagrammes, en voici quelques exemples (la liste n'est pas exhaustive): 
			\begin{itemize}
		...
		La bibliothèque devra être utilisée en tant que composant dans d'autres logiciels,
		chaque objet graphique de la bibliothèque pourra être intégré séparément à d'autres projets, 
	...
	d'utiliser une autre bibliothèque si elle en trouve une plus simple ou qui correspond mieux aux attentes du client.
	\subsection{Évaluation des fonctions}
%	\input{pieuvre.tex}\\ \\
	\subsubsection{Fonctions principales}
	Les fonction principales sont les fonctionnalités attendues lors de l'utilisation du logiciel.\\ 
	...
	\begin{tabular}{|p{2cm}|p{3.5cm}|p{5cm}|p{3cm}|c|}
		...
		\hline
		FC$_3$ & Ergonomie & Nombre de clics pour un élément simple: & 5 clics &$\pm$2\\& &\begin{center}\input{diag1.tex}\end{center}&  & \\
		\hline
			FC$_4$ & Documentation & Temps passé pour trouver la documentation se rapportant à une méthode &30 secondes& $\pm$10secondes \\ 
		\hline
			FC$_5$ & Propreté du code & Complexité cyclomatique& 15 & +5\\ 
		\hline
	\end{tabular}
	...
	\begin{itemize}
		\item Le client doit valider chaque incrément et nous donner les directives pour l'incrément suivant afin de continuer le projet. Cette étape sera réalisée lors des réunions citées un paragraphe plus haut.
	...
	\begin{itemize}
		\item Selon les exigences du client, le projet devra être programmé en Java et le rendu devra s'effectuer sous l'EDI\footnote{Environnement de Développement Intégré} Netbeans. 
...
\section{Glossaire}
	...
	compilé peut être exécuté sur différentes plateforme (Windows, Linux, Mac OS X, \ldots).
