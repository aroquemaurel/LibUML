...
\begin{document}
	...
	\subsection{Présentation du projet}
		...
		le client souhaite avoir un code propre et optimisé (factorisé) afin qu'il soit le plus rapide et le plus abordable pour
...
%	\input{pieuvre.tex}\\ \\
	...
	\begin{tabular}{|p{2cm}|p{3.5cm}|p{5cm}|p{3cm}|c|}
		...
		\hline
		FC3 & Ergonomie & Nombre de clics pour un élément simple: & 5 clics &$\pm$2\\& &\begin{center}\input{diag1.tex}\end{center}&  & \\
		\hline
