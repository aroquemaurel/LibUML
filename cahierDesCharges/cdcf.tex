...
\includepdf[pagecommand={}, landscape]{projetiut-gantt.pdf}
	...
	Le client doit valider chaque incréments et nous donner les directives pour l'incrément suivant afin de pouvoir continuer le projet. \\
	Nous n'avons pas d'horaire aménagés pour le projet et nous n'habitons pas tous dans la même ville, ce qui peut poser des difficultés pour se voir, cependant
	nous aurons la possibilité de travailler à distance et le jeudi midi.
